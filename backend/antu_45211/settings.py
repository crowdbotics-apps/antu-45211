"""
Django settings for antu_45211 project.
...
WSGI_APPLICATION = 'antu_45211.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "antu_45211 API",
    "DESCRIPTION": "API documentation for antu_45211 App",
    "VERSION": "v1",
}
